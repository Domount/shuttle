...
export function createStore(options = {}) {
  const dataDirPath = process.env.LOOM_DATA_DIR || options.dataDir;
  const memoryDirPath = process.env.LOOM_MEMORY_DIR || options.memoryDir;

  if (!dataDirPath || !memoryDirPath) {
    throw new Error("createStore requires dataDir and memoryDir (or LOOM_DATA_DIR / LOOM_MEMORY_DIR)");
  }
