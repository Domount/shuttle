...
/**
 * @param {{ store: import('@loom/store').Store, requestTypes: string[], cycleTypes?: string[] }} options
 */
...
/**
 * @param {{ store?: import('@loom/store').Store, getAgentConfig?: () => Promise<{ agent?: { runnerId?: string, modelId?: string } }>, runners?: Record<string, { execute: Function, executeStream?: Function, getInfo?: Function }>, projectRoot?: string, projectName?: string }} options
 */
